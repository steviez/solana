...
pub mod tests {
    ...
    fn test_combine_ancient_slots_packed_internal() {
        ...
        for num_slots in 0..4 {
            for max_ancient_slots in 0..4 {
                ...
                // any of the several slots could have been chosen to be reusedd
    ...
    fn test_shrink_packed_ancient() {
        ...
        // storages with Arc::strong_count > 1 cannot be pulled out of the recycling bin, so hold refcounts so these storages are never reusedd by the actual test code
