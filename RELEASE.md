...
* Advance the [channel links](https://github.com/anza-xyz/agave/blob/master/RELEASE.md#channels) with the newly created branch becoming edge.
* Add a new section `X.Y.0-Unreleased` for the new edge branch.
...
1. Update [CHANGELOG.md](https://github.com/anza-xyz/agave/blob/master/CHANGELOG.md) to remove the [channel links](https://github.com/anza-xyz/agave/blob/master/RELEASE.md#channels) on the new branch. Additionally, remove any wording about the new branch being unreleased.
