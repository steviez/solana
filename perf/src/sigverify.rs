...
use {
    crate::{
        ...
        packet::{Packet, PacketInterface, Packets},
        perf_libs,
        recycler::Recycler,
    },
    rayon::ThreadPool,
...
pub fn batch_size<P: PacketInterface>(batches: &[Packets<P>]) -> usize {
...
pub fn ed25519_verify_cpu<P: PacketInterface>(batches: &mut [Packets<P>], reject_non_vote: bool) {
    use rayon::prelude::*;
...
pub fn ed25519_verify_disabled<P: PacketInterface>(batches: &mut [Packets<P>]) {
    use rayon::prelude::*;
    let count = batch_size(batches);
...
pub fn mark_disabled<P: PacketInterface>(batches: &mut [Packets<P>], r: &[Vec<u8>]) {
...
pub fn ed25519_verify<P: PacketInterface>(
    ...
    for p in batches.iter() {
        elems.push(perf_libs::Elems {
            ...
            elems: p.packets.as_ptr().cast::<Packet>(),
