...
use solana_transaction_status::{
    ConfirmedBlock, ConfirmedTransaction, EncodedTransaction, Rewards, UiTransactionStatusMeta,
    UiTransactionEncoding, TransactionStatusMeta, TransactionWithStatusMeta,
};
    ...
    pub fn get_confirmed_block(
        ...
        if self.is_root(slot) {
            ...
            if !slot_entries.is_empty() {
                ...
                /*
                    steviez backport note:
                    ConfirmedBlock did not previously have a block_time field so
                    just set to None
                */
                let block_time = None;
        ...
        iterator
            .map(|transaction| {
                ...
                TransactionWithStatusMeta {
                    ...
                    /*
                        steviez backport note:
                        The type returned by Blockstore::read_transaction_status() has not changed;
                        it is still a TransactionStatusMeta. So, mapping it is fine. Additionally,
                        UiTransactionStatusMeta is equivalent to the previous RpcTransactionStatusMeta
                    */
                    meta: self
